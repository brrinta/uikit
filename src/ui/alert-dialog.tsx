			...
			<AlertDialogPrimitive.Popup
				...
				className={cn(
					`data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 data-closed:zoom-out-95 data-open:zoom-in-95
					 bg-background ring-foreground/10 gap-6 rounded-xl p-6 ring-1 duration-100 data-[size=default]:max-w-xs data-[size=sm]:max-w-xs
					  data-[size=default]:sm:max-w-lg group/alert-dialog-content fixed top-1/2 left-1/2 z-50 grid w-full -translate-x-1/2
...
function AlertDialogMedia({ className, ...props }: React.ComponentProps<'div'>) {
	return (
		<div
			...
			className={cn(
				`bg-muted mb-2 inline-flex size-16 items-center justify-center rounded-md sm:group-data-[size=default]/alert-dialog-content:row-span-2
...
type CompoundAlertDialog = typeof AlertDialog & {
...
const AlertDialogComponent = AlertDialog as CompoundAlertDialog;
AlertDialogComponent.Trigger = AlertDialogTrigger;
AlertDialogComponent.Portal = AlertDialogPortal;
AlertDialogComponent.Overlay = AlertDialogOverlay;
...
AlertDialogComponent.Description = AlertDialogDescription;
AlertDialogComponent.Action = AlertDialogAction;
AlertDialogComponent.Cancel = AlertDialogCancel;
