...
import { menuCheckableItemVariants, menuContentVariants, menuItemVariants, menuSubTriggerVariants } from './menu-shared';
		...
		<ContextMenuPrimitive.Portal>
			<ContextMenuPrimitive.Positioner
				...
				<ContextMenuPrimitive.Popup
					...
					className={cn(
						menuContentVariants(),
						'z-50 min-w-36 max-h-(--available-height) origin-(--transform-origin) overflow-x-hidden overflow-y-auto shadow-md outline-none',
						className,
					)}
					{...props}
				/>
...
function ContextMenuItem({
	...
	return (
		<ContextMenuPrimitive.Item
			...
			className={cn(menuItemVariants({ variant }), 'group/context-menu-item', className)}
			{...props}
		/>
	);
}
...
function ContextMenuSubTrigger({
	...
	return (
		<ContextMenuPrimitive.SubmenuTrigger
			...
			data-inset={inset}
			className={cn(menuSubTriggerVariants(), 'gap-0', className)}
			{...props}>
			{children}
...
function ContextMenuCheckboxItem({ className, children, checked, ...props }: ContextMenuPrimitive.CheckboxItem.Props) {
	return (
		<ContextMenuPrimitive.CheckboxItem
			...
			className={cn(menuCheckableItemVariants(), className)}
			checked={checked}
			{...props}>
...
type ContextMenuCompound = typeof ContextMenu & {
...
const ContextMenuCompoundExport = Object.assign(ContextMenu, {
...
export {
	ContextMenuCompoundExport as ContextMenu,
	ContextMenuTrigger,
	ContextMenuContent,
	ContextMenuItem,
