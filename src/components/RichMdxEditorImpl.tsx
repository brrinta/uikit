// src/components/RichMdxEditorImpl.tsx
// Loaded lazily by RichMdxEditor.tsx — heavy deps (@mdxeditor/editor, lexical,
// @lexical/*, codemirror, mdxeditor css) are confined to this chunk.
...
import type { RichMdxEditorProps } from './RichMdxEditor';
...
export const RichMdxEditorImpl: React.FC<RichMdxEditorProps> = ({
	                                                         defaultValue,
	                                                         onValueChange,
	                                                         onChange,
	                                                         value,
